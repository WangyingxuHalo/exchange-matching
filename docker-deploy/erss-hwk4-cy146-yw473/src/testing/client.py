...
def time_measure(tmp):
    id_num = 0
    while id_num < 2000:
        generateCreateRequest(str(id_num + tmp), "10000",{"WWW": "100", "XXX": "200"})
        id_num = id_num + 1
...
if __name__ == "__main__":
    ...
    #     tmp = (i * 2000)
    #     p = Process(target=time_measure, args=(tmp,))
    #     p.start()
    #     processes.append(p)
    ...
    # print("query/ms:%s", (20000/(end_time-start_time)))
